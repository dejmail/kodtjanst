# Generated by Django 3.0.3 on 2020-04-02 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_definition', models.TextField(max_length=500, null=True)),
                ('code_set', models.ForeignKey(default=11, on_delete=django.db.models.deletion.PROTECT, to='kodtjänst.CodeSet')),
            ],
        ),
        migrations.CreateModel(
            name='ExternaKodverk',
        ...
        migrations.CreateModel(
            name='MappedToCodeTerm',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mappad_id', models.CharField(max_length=255)),
                ('mappad_kodverk', models.URLField()),
                ('code', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kodtjänst.CodeText')),
            ],
        ),
    ]

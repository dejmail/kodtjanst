...
$(document).ready(function(){
	$('[data-toggle="popover_nyakodverk"]').popover({
		 ...
		 html: true,
		 content: function () {
			   return '<div class="media"><div class="media-body"><p>Nya kodverk publicerades av VGR IS. Kopiera länkadressen från ikonen genom att höger klicka, kopiera och sedan klistra in i RSS program t.ex Outlook</p></div></div>';
		 },
   }) 
});
...
$(document).ready(function(){
	$('[data-toggle="popover_ändringar"]').popover({
		 ...
		 html: true,
		 content: function () {
			   return '<div class="media"><div class="media-body"><p>Förändringar som har skett i kodverk från VGR IS. Kopiera länkadressen från ikonen genom att höger klicka, kopiera och klistra in i RSS program t.ex Outlook</p></div></div>';
		 },
   }) 
});